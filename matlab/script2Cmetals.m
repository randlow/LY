...
%     if isbetween(thisdate,datetime(1997,10,01),datetime(1997,10,21))==1
%         d97=[d97;1];
%         d08=[d08;0];
%         d11=[d11;0];
    if isbetween(thisdate,datetime(2008,09,12),datetime(2008,10,02))==1
        d08=[d08;1];
       % d97=[d97;0];
        d11=[d11;0];
    elseif isbetween(thisdate,datetime(2011,07,23),datetime(2011,08,12))==1
        d11=[d11;1];
        %d97=[d97;0];
        d08=[d08;0];
    else
...
for i =2:numCols
    idxName=headers{i};
    p=data{i};
    idxRet=price2ret(p);           % Convert prices to log returns 
    %asia=idxRet.*d97;
    gfc=idxRet.*d08;
    us=idxRet.*d11;
    for m=2:MnumCols 
