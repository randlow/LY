...
path1 = r'../scraped/platinum.csv'
df1 = pd.read_csv(path1, skiprows=range(1,2350), nrows=7580)
y1=df1['Platinum']
...
ax2.set_ylabel('Platinum (USD)', color='#ad3434')
...
plt.grid(True)
fig.autofmt_xdate()
plt.savefig('Platinum-sp500.png')
plt.show()